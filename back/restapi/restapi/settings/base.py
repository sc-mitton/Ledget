...
# Ory
ORY_HOOK_AUTH_HEADER = 'HTTP_AUTHORIZATION'
ORY_HOOK_AUTH_SCHEME = 'Api-Key'
ORY_RECOVERY_LINK_EXPIRATION = 30 * 60  # 30 minutes in seconds

# Oathkeeper
OATHKEEPER_JWT_HEADER = 'HTTP_AUTHORIZATION'
OATHKEEPER_JWT_AUTH_SCHEME = 'Bearer'
...
OPTIONAL_PLAID_PRODUCTS = ['liabilities', 'investments']
