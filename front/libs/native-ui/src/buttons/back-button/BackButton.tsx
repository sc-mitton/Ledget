...
export const BackButton = ({ onPress, label }: { onPress: (e: GestureResponderEvent) => void, label?: string }) => {
  const theme = useTheme();

  return (
    <TouchableOpacity onPress={onPress} style={styles.container} activeOpacity={0.5}>
      <View style={styles.chevronContainer}>
        <ChevronLeft stroke={theme.colors.blueText} size={28} strokeWidth={1.75} />
      </View>
