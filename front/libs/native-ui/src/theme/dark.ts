...
const palette = {
  ...
  blue800: `hsl(${blueH}, ${blueS}%, 18%)`,
  blue700: `hsl(${blueH}, ${blueS}%, 23%)`,
  blue650: `hsl(${blueH}, ${blueS}%, 25%)`,
  blue600: `hsl(${blueH}, ${blueS}%, 35%)`,
  blue500: `hsl(${blueH}, ${blueS}%, 49%)`,
  blue400: `hsl(${blueH}, ${blueS}%, 55%)`,
  blue300: `hsl(${blueH}, ${blueS}%, 60%)`,
  blue200: `hsl(${blueH}, ${blueS}%, 65%)`,
  blue100: `hsl(${blueH}, ${blueS + 20}%, 70%)`,
  blue50: `hsl(${blueH}, ${blueS + 20}%, 75%)`,
...
export const darkTheme = createTheme({
  ...
  colors: {
    ...
    creditCardDefaultGradientStart: `hsl(${grayH}, 0%, 30%)`,
    creditCardDefaultGradientEnd: `hsl(${grayH}, 0%, 20%)`,
    ...
    blueTextSecondary: palette.blue200,
