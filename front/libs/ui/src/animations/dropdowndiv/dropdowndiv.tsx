...
const _get_transform_origin = (verticlePlacement: VerticlePlacement, placement: HorizontalPlacement) => {
    if (verticlePlacement === 'top') {
        if (placement === 'middle') {
...
export const DropdownDiv = forwardRef<HTMLDivElement, HTMLProps<HTMLDivElement> & IDropdownDiv>((props, ref) => {
    ...
    const transitions = useTransition(visible, {
        from: {
            ...
            transformOrigin: transformOrigin || _get_transform_origin(verticlePlacement, placement),
        },
        enter: {
            opacity: 1,
            transform: 'scale(1)',
