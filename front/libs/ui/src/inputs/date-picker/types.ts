...
type P =
  ...
  | 'hidden'
  | 'disabledStyle';
export type UnenrichedDatePickerProps<T extends TPicker> = Omit<
  DatePickerProps<T>,
  P
>;
export type DatePickerContextProps<T extends TPicker> = Pick<
  DatePickerProps<T>,
  P
>;

export type TDatePickerContext<TP extends TPicker> = (TP extends 'range'
  ? {
      pickerType: TP;
      ...
      setInputTouchCount: React.Dispatch<
