...
const Edit = ({
    ...
    return (
        ...
        >
            ...
            <path fill={fill} d="M133.7,9.6c-3.6-3.8-8.5-6-13.5-6.1c-4.6,0-8.8,1.7-11.9,4.8L34.2,84.2c-1.7,1.9-1.6,4.8,0.2,6.7l19.5,19.7
            c0.9,0.9,2,1.4,3.3,1.4c0.1,0,0.1,0,0.2,0c1.2,0,2.3-0.5,3.2-1.3l73.5-75.5C140.9,28.2,140.7,17,133.7,9.6z"/>
        </svg>
    )
}
