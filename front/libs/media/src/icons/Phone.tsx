const Phone = ({
    ...
    return (
        <>
            ...
            >
                <g>
                    <path fill="var(--icon-dark)" d="M187.7,245.9h-87.2c-9.1,0-16.5-7.4-16.5-16.5V58.6c0-9.1,7.4-16.5,16.5-16.5h87.2c9.1,0,16.5,7.4,16.5,16.5
                    ...
                    <circle fill="var(--icon-dark)" cx="144.1" cy="67.8" r="6.3" />
                </g>
            </svg>
        </>
    )
