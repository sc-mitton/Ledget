  ...
  return (
    ...
    >
      <Path
        stroke={stroke}
        fill={stroke}
        d="M61.4 0H9.8C4.4 0 0 4.4 0 9.8v101.1c0 5.4 4.4 9.8 9.8 9.8h51.6c5.4 0 9.7-4.4 9.8-9.7V9.8c0-5.4-4.4-9.8-9.8-9.8zm6.7 109.3c0 4.7-3.7 8.5-8.3 8.5H11.3c-4.6 0-8.3-3.7-8.3-8.5v-98c0-4.7 3.7-8.5 8.3-8.5h48.4c4.6 0 8.3 3.7 8.3 8.5l.1 98z"
      />
      <Path
        d="M68.1 109.3c0 4.7-3.7 8.5-8.3 8.5H11.3c-4.6 0-8.3-3.7-8.3-8.5v-98c0-4.7 3.7-8.5 8.3-8.5h48.4c4.6 0 8.3 3.7 8.3 8.5l.1 98z"
        fill={fill}
      />
      <Path
        stroke={stroke}
