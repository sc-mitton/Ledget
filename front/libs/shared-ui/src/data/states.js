...
export const states = [
    ...
    { value: "North Carolina", label: "N. Carolina", abbreviation: "NC" },
    { value: "North Dakota", label: "N. Dakota", abbreviation: "ND" },
    ...
    { value: "Rhode", label: "Rhode", abbreviation: "RI" },
    { value: "South Carolina", label: "S. Carolina ", abbreviation: "SC" },
    { value: "South Dakota", label: "S. Dakota", abbreviation: "SD" },
