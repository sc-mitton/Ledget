...
function animate() {
  ...
  tl.fromTo(text[0], { opacity: 0.2 }, { opacity: 1, duration: 0.2 }, 'start')
    .fromTo(text[1], { opacity: 0.2 }, { opacity: 1, duration: 0.2 }, 'middle')
    .fromTo(text[2], { opacity: 0.2 }, { opacity: 1, duration: 0.2 }, 'end');
  ...
  tl.from(
    dollars,
    {
      ...
      ease: CustomEase.create(
        'custom',
        'M0,0 C0.11,0.494 0.144,0.975 0.328,1.065 0.455,1.126 0.504,1 1,1 '
      ),
    },
    'end-=30%'
  );
