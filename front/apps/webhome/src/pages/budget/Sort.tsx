...
const Button = forwardRef<HTMLButtonElement, React.HTMLAttributes<HTMLButtonElement>>((props, ref) => (
...
const billsOptions = [
    ...
    { id: 5, value: 'amount-asc', label: 'Amount:  Low to High', disabled: false, default: false },
    { id: 6, value: 'amount-des', label: 'Amount:  High to Low', disabled: false, default: false },
]

const categoriesOptions = [
    { id: 1, value: 'alpha-des', label: 'A-Z', disabled: false, default: false },
    { id: 2, value: 'alpha-asc', label: 'Z-A', disabled: false, default: false },
    { id: 3, value: 'limit-asc', label: 'Limit:  Low to High', disabled: false, default: false },
    { id: 4, value: 'limit-des', label: 'Limit:  High to Low', disabled: false, default: false },
    { id: 5, value: 'amount-asc', label: 'Spent:  Low to High', disabled: false, default: false },
    { id: 6, value: 'amount-des', label: 'Spent:  High to Low', disabled: false, default: false },
]

const SortBills = ({ type }: { type: 'bills' | 'categories' }) => {
    const { billsSort, setBillsSort, categoriesSort, setCategoriesSort } = useSortContext()
