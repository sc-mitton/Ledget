...
const HelpModal = withModal((props) => {
    const { register, handleSubmit, formState: { errors }, control, clearErrors } = useForm<z.infer<typeof schema>>({
    ...
    return (
        <div className={styles.helpModal}>
            ...
            <div>
                <p>
                    If you need help with your account, or have feedback, fill out the form below and
