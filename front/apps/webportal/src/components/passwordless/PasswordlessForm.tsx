                ...
                if (isUiNodeInputAttributes(node.attributes)) {
                    ...
                    switch (nodeType) {
                        case "button":
                            ...
                            return (
                                <div className={styles.passwordlessButtonContainer} key={attrs.name}>
                                    <GrayMainButton
...
const PasswordlessForm = ({ flow, helpIcon = true, children }: { flow: any, helpIcon?: boolean, children?: React.ReactNode }) => {
