...
const AccountPicker = (props: ModalScreenProps<'Holdings'>) => {
  ...
  return (
    <Box backgroundColor="modalBox100" style={styles.modalBackground}>
      ...
      <Box paddingHorizontal="pagePadding" style={styles.header}>
        <Header2>Holdings</Header2>
      </Box>
      <Box style={styles.headerSeperator}>
        <Seperator backgroundColor="modalSeperator" />
      </Box>
      <Box paddingHorizontal="pagePadding" style={styles.tableHeader}>
        <Button
          label={'Name'}
          onPress={() =>
            setSort(
          ...
          labelPlacement="left"
          textColor={
            ['nameAsc', 'nameDesc'].includes(sort) ? 'mainText' : 'tertiaryText'
          }
          icon={
            <Icon
              size={15}
              ...
              color={
                ['nameAsc', 'nameDesc'].includes(sort)
                  ? 'mainText'
                  : 'tertiaryText'
              }
            />
        ...
        <Button
          ...
          labelPlacement="left"
          textColor={
            ['amountAsc', 'amountDesc'].includes(sort)
              ? 'mainText'
              : 'tertiaryText'
          }
          icon={
