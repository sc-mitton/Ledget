...
const ContinuousSlot = (props: ContinuousSlotProps) => {
  ...
  useEffect(() => {
    ...
    const newWidth = props.charSizes[
  ...
  return (
    <ReAnimated.View
      layout={props.spring
        ...
        : LinearTransition.duration(props.animationDuration).easing(ReEasing.bezier(...easing).factory())}
      entering={props.charSizes[0]
        ? props.spring
      ...
      {isMeasured
        ...
        <Text
          ...
          onLayout={({ nativeEvent: ne }) => {
            ...
            setMaskTop(- 1 * (PADDING_FRACTION * ne.layout.height))
