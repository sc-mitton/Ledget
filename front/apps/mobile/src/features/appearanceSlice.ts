...
export const { setMode, setCustomMode, setDeviceMode, setUseDeviceApperance } =
...
export const selectUseDeviceAppearance = (state: {
  appearance: ThemeState;
  [key: string]: any;
}) => state.appearance.useDeviceAppearance;
export const selectCustomMode = (state: {
  appearance: ThemeState;
  [key: string]: any;
}) => state.appearance.customMode;
