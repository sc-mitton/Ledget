...
export default function LegalFooter() {
  ...
  return (
    <Box
      style={[styles.legalFooter, Platform.OS === 'ios' && styles.legalFooterIOS]}
      variant='footer'
      flexDirection='column'
      alignItems='center'
    >
      <Text fontSize={15} color='secondaryText' style={styles.firstline}>By continuing, you agree to our</Text>
      <Box flexDirection='row' alignItems='baseline'>
        ...
        />
        <Text fontSize={14} color='secondaryText'>and</Text>
        <Button
          variant='bold'
          fontSize={14}
