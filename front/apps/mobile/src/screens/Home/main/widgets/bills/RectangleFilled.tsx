      ...
      >
        <View style={styles.leftColumnInner}>
          <Text color="secondaryText" fontSize={13}>
            {dayjs(`${year}-${month}-01`).format('MMM')}&nbsp; Bills Paid
          </Text>
            ...
            <View>
              <View style={sharedStyles.numbers}>
                {props.loading ? (
                  ...
                  <DollarCents
                    value={Big(total_monthly_bills_amount)
                ...
                <Text color="tertiaryText" fontSize={13} lineHeight={15}>
                  paid
                </Text>
              </View>
              <View style={sharedStyles.numbers}>
                {props.loading ? (
                  ...
                  <DollarCents
                    value={Big(monthly_bills_amount_remaining)
                      .plus(yearly_bills_amount_remaining)
                      .toNumber()}
                    withCents={false}
                    fontSize={15}
                  />
              ...
              return (
                <View style={styles.cell}>
                  ...
                  <Box style={styles.calendarCell}>
                    <Text
                      color={isBookend ? 'tertiaryText' : 'mainText'}
                      fontSize={12}
                    >
                      {day}
                    </Text>
