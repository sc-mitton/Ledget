    ...
    <View style={styles.container}>
      <View style={sharedStyles.topRow}>
        <View>
          <View style={sharedStyles.topRowHeader}>
            ...
            <Text fontSize={13} color='tertiaryText'>Saved</Text>
          </View>
        ...
        <View>
          <View style={sharedStyles.topRowHeader}>
            ...
            <Text fontSize={13} color='tertiaryText'>Invested</Text>
          </View>
          <View style={sharedStyles.currencyContainer}>
      ...
      <View style={sharedStyles.barsContainer}>
        {Array.from({ length: 3 }).map((_, index) => (
          <View
            style={[(sharedStyles as any)[`barsContainer${index}`], sharedStyles.barContainer]}
          ...
          >
            ...
            />
            <Box style={sharedStyles.incomeBar} backgroundColor='transactionShimmer' />
          </View>
        ))}
      </View>
