...
const TabButtons = (props: Props) => {
  ...
  useEffect(() => {
    ...
    left.value = withSpring(pageIndex * tabButtonsWidth.current / 3, defaultSpringConfig)
  }, [pageIndex])
    ...
    <View style={styles.container}>
      ...
      >
        <View
          ...
          onLayout={(e) => tabButtonsWidth.current = e.nativeEvent.layout.width}
        >
          <View style={styles.tabButton}>
            ...
            >
              <Text color={pageIndex === 0 ? 'mainText' : 'tertiaryText'}>Monthly</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.tabButton} >
            <TouchableOpacity
            ...
            >
              <Text color={pageIndex === 1 ? 'mainText' : 'tertiaryText'}>Yearly</Text>
            </TouchableOpacity>
          </View>
          <View style={styles.tabButton}>
            <TouchableOpacity
            ...
            >
              <Text color={pageIndex === 2 ? 'mainText' : 'tertiaryText'}>Once</Text>
            </TouchableOpacity>
          </View>
