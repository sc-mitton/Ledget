  ...
  return (
    <Animated.View
      ...
      <View style={styles.lc}>
        <Box backgroundColor='transactionShimmer' style={styles.lctr}>
        </Box>
        <Box backgroundColor='transactionShimmer' style={styles.lcbr}>
        </Box>
      </View>
      <View style={styles.rc}>
        <Box backgroundColor='transactionShimmer' style={styles.rctr}>
        </Box>
      </View>
    </Animated.View>
  )
