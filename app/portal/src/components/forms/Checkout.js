...
function CheckoutWindow() {
    ...
    const BillingForm = ({ onSubmit }) => {
        ...
        return (
            <form onSubmit={handleSubmit(onSubmit)} className="checkout-form" id="billing-form">
                ...
                <div id="subscription-radios-container">
                    {prices.map((p, i) =>
                        <div className="subscription" key={`subscription-${i}`}>
                            ...
                            >
                                <span className="nickname">{p.nickname.toUpperCase()}</span>
        ...
        return (
            <div id="checkout-container">
                ...
                <div className="subscribe-button-container">
                    <button
                        className={`${(inputsValid && payment && !processing && !succeeded)
